...
namespace WebAtividadeEntrevista
{
    public static class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/jqueryminput").Include(
            ...
            bundles.Add(new ScriptBundle("~/bundles/beneficiariosAlt").Include(
                      "~/Scripts/Beneficiario/FI.BeneficiarioAlt.js"));
            
            bundles.Add(new ScriptBundle("~/bundles/verificaCpf").Include(
                      "~/Scripts/Shared/FI.VerificaCpf.js"));
